...
class HikmetliSozlerCardScreen extends StatefulWidget {
  @override
  State<HikmetliSozlerCardScreen> createState() => _HikmetliSozlerCardScreenState();
}

class _HikmetliSozlerCardScreenState extends State<HikmetliSozlerCardScreen> with TickerProviderStateMixin{
  ...
  var _url = Uri.parse("https://www.gozelislam.com/hikmetli-sozler/");
  ...
  Future<Null> saveAndShare(String zor, int index) async {
    ...
    if (Platform.isAndroid) {
      ...
      File imgFile = new File('$documentDirectory/hikmetli_sozler${index}.jpg');
      imgFile.writeAsBytesSync(response.bodyBytes);
      Share.shareFiles(['$documentDirectory/hikmetli_sozler${index}.jpg'],
  ...
  Future<List> _getData()async{
    ...
    var res = document.getElementsByClassName("xfieldimagegallery hikmetli").forEach((element)async {
