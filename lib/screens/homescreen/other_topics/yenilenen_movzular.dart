...
class YenilenenMovzular extends StatefulWidget {
  @override
  State<YenilenenMovzular> createState() => _YenilenenMovzularState();
}

class _YenilenenMovzularState extends State<YenilenenMovzular> {
  var prayerTime;
