              ...
              children: [
                ...
                ListTile(
                  onTap: (){
                    ...
                    leading: Icon(Icons.color_lens_outlined, color: Colors.red),
                    title: Text("Renk", style: GoogleFonts.alatsi(),),
                    subtitle: Text(pickerColor.toString(),),
                    trailing:  Icon(Icons.colorize, color: Colors.red),
                ),
                ListTile(
                  onTap: (){
                    _selectFont();
                  },
                    leading: Icon(Icons.font_download_outlined, color: Colors.red),
                ...
                ListTile(
                  leading: Icon(Icons.blur_circular, color: Colors.red),
